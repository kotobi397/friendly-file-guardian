        ...
        <CardContent className="space-y-4">
          <Alert>
            <AlertDescription className="text-sm">
              ...
              ويضعها في الجدول أدناه (مع تصفّح الصفحات التالية للحصول على مئات الكتب)، ثم ينشر التقييم والتعليق بحسابك كتاباً بعد كتاب.
              النشر يعمل أيضاً على الخادم تلقائياً كل 10 دقائق، لذا تستمر التقييمات حتى وأنت خارج الموقع.
