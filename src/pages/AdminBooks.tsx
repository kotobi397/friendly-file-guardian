...
import NoorReviewsManager from '@/components/admin/NoorReviewsManager';
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <div className="mb-8 overflow-x-auto">
              <TabsList className="inline-flex h-auto w-max min-w-full justify-start p-1">
                ...
                <TabsTrigger value="noor_reviews" className="flex-shrink-0 text-sm md:text-lg px-4 md:px-8 whitespace-nowrap">
                  ⭐ تقييم كتب نور بوك
                </TabsTrigger>
